...
BASE_URL = "https://www.sharpandcarter.com.au/jobs"


def fetch_sharpcarter_au() -> list[dict]:
    print("[Sharp & Carter AU] Fetching…")
    results: list[dict] = []
    ...
    for title in AU_TITLES:
        ...
        for item in items:
            ...
            if link and link.startswith("/"):
                link = "https://www.sharpandcarter.com.au" + link
    ...
    print(f"[Sharp & Carter AU] Total jobs fetched: {len(results)}")
    return results
